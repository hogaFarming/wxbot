webpackJsonp([1], [function (e, exports, t) {
  ...
  angular.module("Controllers", []), t(278), t(279), t(280), t(282), t(283), t(285), t(286), t(287), t(288), t(289), t(290), t(291), 
  angular.module("Services", []), t(292), t(293), t(294), t(295), t(296), t(297), t(298), t(299), t(300), t(301), t(302), t(303), t(304), t(305), t(306), t(307), t(308), t(310), t(311), t(312), t(313), 
  angular.module("Directives", []), t(314), t(315), t(316), t(317), t(318), t(319), t(320), t(321), t(322), t(323), t(324), t(325), t(326), t(327), t(328), t(329), t(330), t(331), t(332), t(333), t(334), t(335), t(336), t(337), t(338), t(339), 
  angular.module("Filters", []), t(341), t(342), function () {
    "use strict";
    angular
      .module("webwxApp", ["ui.router", "ngAnimate", "Services", "Controllers", "Directives", "Filters", "ngDialog", "jQueryScrollbar", "ngClipboard", "exceptionOverride"])
          ...
          navView       : {
            controller: ["$stateParams", "chatFactory", "contactFactory", "stateManageService", "$rootScope", function (e, t, a, n, i) {
              function o() {
                ...
                i.$broadcast("root:statechange"), t.setCurrentUserName(e.userName), t.addChatList([n || {FromUserName: e.userName}]), e.userName = ""
              }

              if (n.change("navChat:active", !0), e.userName) {
                var r = a.getContact(e.userName, "", !0);
                r ? o() : a.addBatchgetContact({UserName: e.userName, ChatRoomId: ""}, !0).then(function (e) {
                  o()
                }, function (e) {
                })
              }
            }]
          }, contentView: {templateUrl: "contentChat.html", controller: "contentChatController"}
        }
      }).state("contact", {
        url: "", views: {
          navView    : {
        ...
        views : {
          ...
          contentView: {
            ...
            controller : ["$scope", "$stateParams", "subscribeMsgService", "mmpop", function (e, t, a, n) {
              if (t.readItem) c = e.readItem = t.readItem; else {
  ...
  !function () {
    ...
    location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
    ...
    }]) : angular.module("exceptionOverride", []), angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "monitorService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h, M, v, y, b, C, w) {
      function S() {
        return d.pickContacts(["friend", "chatroom"], {
          chatroom: {keyword: t.keyword, isNewArray: !0},
          friend  : {
            keyword         : t.keyword,
            isNewArray      : !0,
            isWithoutBrand  : !0,
      ...
      function N() {
        t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {timing: {initStart: Date.now()}}), 
        s.init().then(function (n) {
          if (h.log("initData", n), 
          n.BaseResponse && "0" != n.BaseResponse.Ret) return void(l.timeoutDetect(n.BaseResponse.Ret) || (r.openConfirm({
            className  : "default ",
          ...
          h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), 
          t.$broadcast("updateUser"), 
          M.report(M.ReportType.timing, {timing: {initEnd: Date.now()}});
            ...
            function e(a) {
              d.initContact(a).then(function (a) {
                d.addContacts(a.MemberList), M.report(M.ReportType.timing, {
                  timing  : {initContactEnd: Date.now()},
                  needSend: !0
                }), t <= 16 && a.Seq && 0 != a.Seq && (t++, e(a.Seq))
              })
            }

            M.report(M.ReportType.timing, {timing: {initContactStart: Date.now()}});
            var t = 1;
            e(0)
          }, 0), 
      ...
      function G(e) {
        ...
        try {
          ...
          e.other = {reason: "throw err when syncChackHasChange"}, window._errorHandler && window._errorHandler(e)
        } finally {
          E()
        }
      }
      ...
      window._appTiming = {};
      i.go("chat"), 
      e.CONF = m, t.isUnLogin = !window.MMCgi.isLogin, 
      t.debug = !0, 
          ...
          return t.keyword ? (U && U.close(), void(U = c.open({
            ...
            controller : ["$rootScope", "$scope", "$state", function (e, t, a) {
              t.$watch(function () {
                ...
                n.UserName && (a.go("chat", {userName: n.UserName}), t.closeThisMmPop(), e.$broadcast("root:searchList:cleanKeyWord"))
              }
            }],
            scope      : {
              keyword    : t.keyword,
      ...
      if (t.account) {
        var a = t.account, n = e.pageY + 25, o = e.pageX + 6;
        c.open({
          ...
          controller : ["$scope", function (e) {
            e.contact = a, e.addUserContent = "", e.isShowSendBox = !1, e.chat = function (t) {
              i.go("chat", {userName: t}), e.closeThisMmPop()
            }
          }]
        })
      }
    ...
    angular.module("Controllers").controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", "monitorService", function (e, t, a, n, i) {
        ...
        switch (c.code) {
          case 200:
            t.newLoginPage(c.redirect_uri).then(function (t) {
              var o = t.match(/<ret>(.*)<\/ret>/), r = t.match(/<script>(.*)<\/script>/),
                  c = t.match(/<skey>(.*)<\/skey>/), s = t.match(/<wxsid>(.*)<\/wxsid>/),
                  l = t.match(/<wxuin>(.*)<\/wxuin>/), d = t.match(/<pass_ticket>(.*)<\/pass_ticket>/),
                  f = t.match(/<message>(.*)<\/message>/), u = t.match(/<redirecturl>(.*)<\/redirecturl>/);
            ...
            break;
          case 201:
            e.isScan = !0, n.report(n.ReportType.timing, {timing: {scan: Date.now()}}), t.checkLogin(e.uuid).then(o, function (t) {
      ...
      function r() {
        t.getUUID().then(function (i) {
          a.log("login", i), e.uuid = i, e.qrcodeUrl = "https://login.weixin.qq.com/qrcode/" + i, e.code = 0, e.isScan = !1, e.isIPad = a.isIPad, e.isMacOS = a.isMacOS, e.isWindows = a.isWindows, e.lang = a.queryParser().lang || "zh_CN";
          var r = !1;
          n.report(n.ReportType.timing, {timing: {qrcodeStart: Date.now()}}), 
          setTimeout(function () {
          r || n.report(n.ReportType.picError, {text: "qrcode can not load", src: e.qrcodeUrl})
        }, 3e3), 
          e.qrcodeLoad = function () {
          r = !0, n.report(n.ReportType.timing, {timing: {qrcodeEnd: Date.now()}})
        }, 
      ...
      if ($(".lang .lang-item").click(function (e) {
        ...
        e.isWaitingAsConfirm = !0, t.associationLogin(n).then(function (t) {
          e.uuid = t.uuid, c()
        }, function (t) {
        ...
        window.MMCgi.isLogin || e.isAssociationLogin 
  ...
  !function () {
    ...
    angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h, M, v, y) {
      function b(t) {
        ...
        if (n && (e.unreadMessageCount = n.unreadCount, n.unreadCount = 0), e.isChangeUserFlag = !0, e.currentUser = t, e.chatContent = c.getChatMessage(t, !0), e.unreadMessage = e.chatContent[e.chatContent.length - e.unreadMessageCount], e.imagesMessagesList = [], e.messagesAnimate = !1, a(function () {
            e.messagesAnimate = !0
          }, 200), n) {
      ...
      e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, o.find("#chatArea").on("drop", function (e) {
      ...
      e.$on("onScroll", function (t, a) {
        ...
        var o = t.MMStatus;
        void 0 !== o && o != f.MSG_SEND_STATUS_SUCC || h.open({imageList: e.imagesMessagesList, current: n})
      }, e.resendMsg = function (e) {
        c.sendMessage(e)
      }, e.imageInit = function (t, a) {
        for (var n, i, o, r = e.imagesMessagesList, c = !1, i = e.getMsgImg(t.MsgId), s = 0; s < r.length; s++) if (n = r[s], n.msg === t) {
          c = !0, n.url = i, o = s;
          break
        }
        if (!c) {
          ...
          controller     : ["$scope", function (t) {
            a(function (a) {
              ...
              p.open({
                ...
                data       : {isCreate: !0, initSelectedContacts: [t.currentContact]}
              }), t.closeThisMmPop()
            }
          }]
        ...
        var r = angular.element(window), c = 230, d = 360, u = r.width(), m = r.height(), h = t.pageY, M = t.pageX;
        u - t.pageX < c && (M = t.pageX - c), m - t.pageY < d && (h = t.pageY - d), g.open({
          ...
          singletonId: "mmpop_profile",
          controller : ["$scope", function (e) {
            o.VerifyFlag && (e.isOfficialUser = !0), e.contact = o, e.MMDefaultRemark = _("8d521cc"), e.addUserContent = _("5a97440") + y.formatHTMLToSend(s.getUserInfo().NickName), e.isShowSendBox = i || !1, e.chat = function (t) {
              n.go("chat", {userName: t}), e.closeThisMmPop()
              ...
              var a = $(".profile_mini_wrap .J_Text"), n = a.text(), i = n.length;
      ...
      e.playVoice = function (e) {
        t.e(2, function (require) {
          ...
          e.MMVoiceUnRead && (e.MMVoiceUnRead = !1), e.MMPlaying = !0, a.jPlayer({
            ...
            supplied  : "mp3",
            wmode     : "window"
          }), a.jPlayer("stop"), window.MMplayingMsg = e, a.jPlayer("setMedia", {mp3: n}), a.jPlayer("play")
        })
      };
      var G       = !1;
      ...
      e.$watchCollection("chatContent", function (t) {
        if (t.length > 0 && t[t.length - 1].FromUserName === s.getUserName()) G = !0; else {
        ...
        var n = "<div message-directive ></div>", i = e.$new();
        i.imageInit = function () {
        }, i.message = t;
        var o = r(n)(i);
        $("#prerender").append(o), function (t, a, n, i) {
          setTimeout(function () {
            function o() {
            ...
            if (n.MsgType == f.MSGTYPE_EMOTICON || n.MsgType == f.MSGTYPE_IMAGE || n.MsgType == f.MSGTYPE_VIDEO) {
              t.$digest();
              var c = a.find(".content .msg-img"), s = c.height(), l = {};
              if (n.ImgHeight) n.MsgType == f.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth + "px", l.widht = c.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l, t.$digest(), i(a.height()), t.$destroy(), a.remove(); else if (s > 40 || 1 == c[0].complete && 0 !== c[0].naturalWidth && s > 0) i(a.height()), t.$destroy(), a.remove(); else {
  ...
  !function () {
    ...
    angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", "monitorService", function (e, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h) {
      ...
      function C(e) {
        var t, a, n = "";
        if (window.getSelection) t = window.getSelection(), t.rangeCount > 0 && (a = t.getRangeAt(0).cloneRange(), a.collapse(!0), a.setStart(x, 0), n = a.toString().slice(-e)); else if ((t = document.selection) && "Control" != t.type) {
          var i;
      ...
      function w(e, t) {
        ...
        if (t || y(), window.getSelection) {
          ...
          var i;
          if (n.createContextualFragment) i = n.createContextualFragment(e); else {
        ...
        } else n = t || !U ? document.selection.createRange() : U, e = e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;"), n.pasteHTML(e), n.select()
      }

      function S() {
        window.getSelection && (window.getSelection().getRangeAt(0).insertNode(A), F = A.offsetLeft, V = A.offsetTop - x.scrollTop, D.appendChild(A))
      }

      function T(t) {
        var a = o.open({
          template     : "imageUploadPreview.html", controller: ["$scope", function (e) {
            R     = !0;
            var a = "";
        ...
        return {
          update  : function (t, a) {
            e.$broadcast("root:uploadImg:success", {src: t, mediaId: a})
          }, close: a.close
        }
      }
      ...
      function I(e, t) {
        angular.extend(e, {onQueued: X, onProgress: X, onSuccess: X, onError: X}, t)
      }
        ...
        t.e(3, function (require) {
          ...
          try {
            K = e.create({
              ...
              if (/untitled\d+.png/i.test(e.name) || j) I(e, ee), e.ToUserName = l.getSendFileUsername(); else if (e.ToUserName = l.getSendFileUsername(), I(e, Z), "gif" !== e.ext.toLowerCase() && !E(e.ext)) {
                var t = G(e.ext);
              ...
              return K.md5File(e).then(function (t) {
                function a(e, t, a) {
                  ...
                  var s = {
                    mediatype         : n,
                    uploadmediarequest: JSON.stringify(angular.extend({UploadType: 1}, i)),
                ...
                var s = Date.now() - o, l = s / e.size * 1024 * 1024;
                ...
                if (i) {
                  ...
                  d = angular.extend({}, u), n({method: "POST", url: r.API_checkupload, data: m}).success(function (t) {
              ...
              var n = e.file;
              n._data || {};
              angular.extend(t, n._uploadParams, {uploadmediarequest: JSON.stringify(angular.extend({UploadType: 2}, n._uploadmediarequestBase))})
              ...
              p.report(p.ReportType.uploaderError, {text: "WebUploader 出错", type: e}), h.report(h.UPLOAD_FAIL_COUNT, 1)
            })
          } catch (e) {
            a.noflash = !0, p.report(p.ReportType.uploaderError, {text: "WebUploader 出错", type: "no_flash"})
          }
        })
      }

      var P, U, A = document.getElementById("caretPosHelper"), F = 0, V = 0, x = document.getElementById("editArea"),
          D = x.parentNode, O = f.getShareObject("editingContents"), R = !1, j = !1, q = null;
      $(x).on("input", function () {
        v()
      }).on("click", function () {
        v()
      ...
      }), a.isDisabled = !a.userName, a.isMacOS = navigator.userAgent.toUpperCase().indexOf("MAC OS") > -1, a.editAreaCtn = "";
      var L;
      ...
      a.sendClick = function (e) {
        ...
        d.isSupport() ? d.capture({
          ok: function () {
            var t = l.createMessage({MsgType: r.MSGTYPE_IMAGE, Type: r.MSGTYPE_IMAGE});
      ...
      a.editAreaKeyup = function (e) {
        ...
        if (t == r.KEYCODE_ENTER) {
          if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) {
            ...
            if (!f.browser.msie && window.getSelection) {
              ...
              do if (!i || i.nodeValue || "BR" == i.tagName) break; while (i = i.nextSibling);
              i || (n += n)
            }
        ...
        if (u.close(), !a.editAreaCtn.replace(/<br\/?>/g, "").match(/^\s*$/)) {
          var e = l.createMessage({MsgType: r.MSGTYPE_TEXT, Content: a.editAreaCtn});
        ...
        var a = l.createMessage({MsgType: r.MSGTYPE_EMOTICON, Content: e, EmojiFlag: r.EMOJI_FLAG_GIF, EMoticonMd5: e});
        a.MMPreviewSrc = r.RES_PATH + "images/icon/Tuzki/" + t, l.appendMessage(a), l.sendMessage(a)
      }, a.sendGif = function (e) {
      };
      var K, W = 20, z = 25, Q = {bmp: 1, png: 1, jpeg: 1, jpg: 1, gif: 0}, J = function (e) {
  ...
  !function () {
    ...
    angular.module("Controllers").controller("emojiController", ["$rootScope", "$scope", "$timeout", "emojiFactory", "confFactory", "utilFactory", function (e, t, a, n, i, o) {
      a(function () {
        ...
        var a = e.target;
        if ("A" == a.tagName) {
          var i = a.innerText || a.textContent, r = a.getAttribute("type");
          switch (r) {
            case"qq":
    ...
    angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", "monitorService", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h) {
      a(function () {
        t.ngDialogData.isCreate && (M = []), t.allContacts = c.pickContacts(["star", "friend"], {
          star  : {filterContacts: M},
          friend: {
            filterContacts: M,
            isWithoutStar : !0,
            isWithoutBrand: !0
          }
        }, !0).result, t.chatroomContacts = c.pickContacts(["chatroom"], {chatroom: {noHeader: !0}}, !0).result
      }, 100), t.selectedUsers = t.ngDialogData.initSelectedContacts || [];
      var M = t.ngDialogData.isCreate ? {} : l.getFilterContacts();
      t.pickConfig = {
        types: ["star", "friend"],
        opt  : {star: {}, friend: {isWithoutStar: !0, isWithoutBrand: !0}, all: {filterContacts: M}}
      }, t.add = function () {
        var e = l.getCurrentContact(), a = [];
        ...
        return angular.forEach(t.selectedUsers, function (e, a) {
        ...
        }), 1 === t.selectedUsers.length ? (n.go("chat", {userName: t.selectedUsers[0].UserName}), void t.closeThisDialog()) : (angular.forEach(t.selectedUsers, function (t) {
          e.push({UserName: t.UserName})
        }), l.create(e).then(function (e) {
          e.BaseResponse && 0 == e.BaseResponse.Ret || e.BaseResponse.Ret == -2013 ? n.go("chat", {userName: e.ChatRoomName}) : (u.openConfirm({
            className  : "default ",
            templateUrl: "comfirmTips.html",
            controller : ["$scope", function (t) {
          ...
          u.openConfirm({
            className: "default ", templateUrl: "comfirmTips.html", controller: ["$scope", function (t) {
              t.title = _("02d9819"), t.content = e.BaseResponse.ErrMsg || _("0d42740"), t.callback = function () {
                t.closeThisDialog()
              }
            }]
        ...
        n.go("chat", {userName: e.UserName}), t.closeThisDialog()
    ...
    angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function (e, t, a, n, i, o, r, c, s, l, d, f) {
      function u(e) {
        ...
        for (var n = [e.target], i = e.path || e.originalEvent.path || a(e.target), o = 0, r = i.length; o < r; o++) {
          ...
          if (c) {
            ...
            var s = angular.element(document.getElementById("contextMenu")), l = angular.element(window), d = s.width(),
                f = s.height(), u = l.width(), M = l.height();
            u - e.pageX < d && (t.contextStyle = {
              top : e.pageY,
              left: e.pageX - d
            }), M - e.pageY < f && (t.contextStyle = {top: e.pageY - f, left: e.pageX - d});
            break
          }
        }
      }
      ...
      function m(a) {
        ...
        (n.isRoomContact() || n.isContact()) && (n.isTop() ? t.contextMenuList.push({
          ...
          content: _("3d43ff1"), callback: function () {
            r.setTopContact(a, !0)
          }
        })), n.isRoomContact() && t.contextMenuList.push({
          content: _("1f9be6d"), callback: function () {
            c.open({
          ...
          content: _("685739c"), callback: function () {
      ...
      function g(a) {
        t.contextMenuList = [{
          content: _("91382d9"), callback: function () {
      ...
      function p(n, i, o) {
        var r = [{
          content: _("7068541"), callback: function () {
            e.$broadcast("root:profile", {userName: i, event: n})
          }
        }];
        "true" == o ? r.push({
          content: _("b5f1591"), callback: function () {
            a.go("chat", {userName: i})
          }
        }) : r.push({
          content: _("0bd10a8"), callback: function () {
            e.$broadcast("root:profile", {userName: i, isAdd: !0, event: n})
          }
        }), t.contextMenuList = r
      }
      ...
      function h(a, n, s, l, u) {
        function m(e) {
          ...
          if (t = angular.element(t), t.hasClass("js_message_bubble") || (t = t.parents(".js_message_bubble")), t = t.find(".js_message_plain"), t.length) {
            var a = t.html().replace(new RegExp("<(?!br|" + o.EMOTICON_REG + ").*?>", "g"), ""), n = d.htmlDecode(a);
            return n
          }
          return ""
        }
        ...
        var p = g.MMDigest, h = r.getContact(a), M = r.getContact(g.FromUserName);
        ...
        switch (t.contextMenuList = [], (!g._noSupportMsg || g.AppMsgType != o.APPMSGTYPE_TRANSFERS && g.AppMsgType != o.APPMSGTYPE_REALTIME_SHARE_LOCATION && g.AppMsgType != o.APPMSGTYPE_CARD_TICKET) && ("filehelper" != g.MMPeerUserName && i.getUserName() == g.FromUserName && Date.now() / 1e3 - g.CreateTime < 120 ? t.contextMenuList.push({
          ...
          case o.MSGTYPE_TEXT:
            ...
            p = v ? v + ":" + g.MMActualContent : g.MMActualContent, p = p.replace(":", ": "), t.contextMenuList.push({
              ...
              isCopy         : !0, content: _("79d3abe"), callback: function () {
        ...
        (g.MMIsAppMsg || g.MsgType != o.MSGTYPE_IMAGE && g.MsgType != o.MSGTYPE_TEXT && g.MsgType != o.MSGTYPE_VIDEO && g.MsgType != o.MSGTYPE_MICROVIDEO && g.MsgType != o.MSGTYPE_LOCATION && g.MsgType != o.MSGTYPE_EMOTICON) && (g.MsgType != o.MSGTYPE_APP && !g.MMIsAppMsg || g.AppMsgType != o.APPMSGTYPE_ATTACH) || g._noSupportMsg || t.contextMenuList.push({
          ...
          content: _("2f4aadd"), callback: function () {
            f.localDelete(g)
          }
  ...
  !function () {
    ...
    angular.module("Controllers").controller("editAreaContactListController", ["$scope", "confFactory", "utilFactory", "$timeout", function (e, t, a, n) {
      ...
      function o(e) {
        var t = d + f, a = e * t, n = c.scrollTop;
        if (n > a) return void(c.scrollTop = a);
        var i = a + t + f - c.offsetHeight;
        n < i && (c.scrollTop = i)
      }

      var r = document.getElementById("editArea"), c = document.getElementById("editAreaContactPanel"),
          s = document.getElementById("caretPosHelper"), l = e.memberList.length - 1, d = 42, f = 10;
    ...
    angular.module("Controllers").controller("systemMenuController", ["$rootScope", "$scope", "$timeout", "ngDialog", "loginFactory", "confFactory", "accountFactory", "utilFactory", "monitorService", "oplogFactory", function (e, t, a, n, i, o, r, c, s, l) {
      t.createChatroom = function () {
        n.open({
          ...
          className      : "default create_chatroom_dlg",
          closeByDocument: !1,
          data           : {isCreate: !0, fromSystemMenu: !0}
        }), t.closeThisMmPop()
      }, t.loginout = function () {
        ...
        n.open({
          templateUrl  : "feedback.html", controller: ["$scope", function (e) {
  ...
  !function () {
    ...
    angular.module("Controllers").controller("readMenuController", ["$rootScope", "$scope", "subscribeMsgService", function (e, t, a) {
      t.copyCallback = function () {
        ...
        var e = a.current.Url, n = window.open(e, "_blank");
    ...
    angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p) {
      function h(e, t) {
        if (e.MsgType != d.MSGTYPE_SYS) {
          ...
          a.ToUserName = t, a.FromUserName = p.getUserName(), a.isTranspond = !0, a.MsgIdBeforeTranspond = e.MsgIdBeforeTranspond || e.MsgId, a._h = void 0, a._offsetTop = void 0, a.MMSourceMsgId = e.MsgId, a.Scene = 2, a = r.createMessage(a), a.sendByLocal = !1, a.Content = m.htmlDecode(a.Content.replace(/^@\w+:<br\/>/, "")), a.MMActualSender = p.getUserName(), a.MMSendContent && (a.MMSendContent = a.MMSendContent.replace(/^@\w+:\s/, "")), a.MMDigest && (a.MMDigest = a.MMDigest.replace(/^@\w+:/, "")), a.MMActualContent && (a.MMActualContent = m.clearHtmlStr(a.MMActualContent.replace(/^@\w+:<br\/>/, ""))), r.appendMessage(a), r.sendMessage(a)
        }
      }
      ...
      t.pickConfig = {
        ...
        opt  : {star: {}, chatroom: {isSaved: !0}, friend: {isWithoutStar: !0, isWithoutBrand: !0}}
      };
      var v        = angular.copy(r.getChatList());
      v.unshift({text: _("b3b6735"), type: "header"}), t.initList = v, t.ensure = function () {
  ...
  !function () {
    ...
    angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c) {
      var s = {
        globalData  : {chatList: []}, init: function () {
          var e = t.defer();
          return c({
            method : "POST",
            url    : a.API_webwxinit,
            MMRetry: {count: 1, timeout: 1},
            data   : {
              BaseRequest: {
                Uin     : n.getUin(),
                Sid     : n.getSid(),
          ...
          return c({
            ...
            data   : angular.extend(n.getBaseRequest(), {SyncKey: n.getSyncKey(), rr: ~new Date})
          }).success(function (t) {
            e.resolve(t), 
          ...
          return window.synccheck && (window.synccheck.selector = 0), 
            ...
            timeout : 35e3
              ...
              (window.synccheck && "0" == window.synccheck.retcode)
                ? "0" != window.synccheck.selector 
                    ? c.sync().then(function (t) {
                        e.resolve(t)
                      } , function (e) {
                      })
                    : e.reject(window.synccheck && window.synccheck.selector) 
                : (!window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode)
                    ? (window.synccheck && "1100" == window.synccheck.retcode)
                        ? i.loginout(0) 
                        : (e.reject("syncCheck net error") , r.report(r.ReportType.netError, {
  ...
  !function (_aoUndefined) {
    ...
    angular.module("Services").factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
      ...
      var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "",
          _addedMsgIdsMap = {},
          _msgMap = {},
          ...
          service = {
            ...
            _sendCheck                         : function (e) {
              var t = $("#chatArea .title_wrap .title_name")[0], a = $("#J_NavChatScrollBody")[0];
              if (t && a) {
                var n = $(t), i = $(a), o = n.attr("data-username"), r = i.attr("data-username");
                return o && r || utilFactory.reportSendState("sendcheckAttrError"), e || utilFactory.reportSendState("toUserNameNotFound"), !(!e || o != r || r != e) || (r != e && utilFactory.reportSendState("toUserNameConflictNav"), o != e && utilFactory.reportSendState("toUserNameConflictChat"), utilFactory.reportSendState("uiCheckFail"), reportService.report(reportService.ReportType.sendError, {
                  type: "uiCheckFail",
            ...
            _postMessage                       : function (url, data, msg) {
              data.FromUserName = msg.FromUserName
                ...
                , utilFactory.browser.msie 
                  && parseInt(utilFactory.browser.version) < 9 
                  && url == confFactory.API_webwxsendmsg 
            ...
            postTextMessage                    : function (e) {
              var t = {Type: confFactory.MSGTYPE_TEXT, Content: e.MMSendContent};
              e.MMAtContacts 
                && e.MMAtContacts.length 
                && (t.MsgSource = "<msgsource><atusername>" + e.MMAtContacts + "</atusername><atchatroomname>" + e.ToUserName + "</atchatroomname></msgsource>")
            ...
            postImgMessage                     : function (e) {
              var t = {Type: confFactory.MSGTYPE_IMAGE, MediaId: e.MediaId, Content: e.Content};
              this._postMessage(confFactory.API_webwxsendmsgimg + "?fun=async&f=json", t, e)
            }, 
            postVideoMessage                   : function (e) {
              var t = {Type: confFactory.MSGTYPE_VIDEO, MediaId: e.MediaId, Content: e.Content};
              this._postMessage(confFactory.API_webwxsendmsgvedio + "?fun=async&f=json", t, e)
            }, 
            postMicroVideoMessage              : function (e) {
              var t = {Type: confFactory.MSGTYPE_MICROVIDEO, MediaId: e.MediaId, Content: e.Content};
              this._postMessage(confFactory.API_webwxsendmsgvedio + "?fun=async&f=json", t, e)
            }, 
            ...
            addChatList                        : function (e) {
              ...
              e && (angular.isArray(e) || (e = [e]), angular.forEach(e, function (e, t) {
                var a = "", n = 0;
                if (a = e.UserName ? e.UserName : e.FromUserName == accountFactory.getUserInfo().UserName ? e.ToUserName : e.FromUserName, n = _chatList.indexOf(a), n == -1) _chatList.unshift(a), utilFactory.isRoomContact(a) && contactFactory.addBatchgetChatroomContact(a); else {
            ...
            _getLastMessage                    : function (e) {
              var t = this, a = t.getChatMessage(e);
            ...
            messageProcess: function (e) {
              var t = this, a = contactFactory.getContact(e.FromUserName, "", !0);
              ...
              if (e.MsgType != confFactory.MSGTYPE_SYSNOTICE && !(utilFactory.isShieldUser(e.FromUserName) || utilFactory.isShieldUser(e.ToUserName) || e.MsgType == confFactory.MSGTYPE_VERIFYMSG && e.RecommendInfo && e.RecommendInfo.UserName == accountFactory.getUserInfo().UserName)) {
                ...
                e.MMIsSend || n && (n.isMuted() || n.isBrandContact()) || e.MsgType == confFactory.MSGTYPE_SYS || (accountFactory.isNotifyOpen() && t._notify(e), accountFactory.isSoundOpen() && utilFactory.initMsgNoticePlayer(confFactory.RES_SOUND_RECEIVE_MSG)), t.addChatMessage(e), t.addChatList([e])
              }
            }, 
            ...
            _commonMsgProcess: function (e) {
              ...
              e.Content = e.Content || "", e.MMDigest = "", e.MMIsSend = e.FromUserName == accountFactory.getUserName() || "" == e.FromUserName, a = n.getChatMessage(e.MMPeerUserName), utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !0, i = e.Content.replace(/^(@[a-zA-Z0-9]+|[a-zA-Z0-9_-]+):<br\/>/, function (e, t) {
                return o = t, ""
              }), o && o != accountFactory.getUserName() && (t = contactFactory.getContact(o, e.MMPeerUserName), t && (r = t.getDisplayName(e.MMPeerUserName), r && (e.MMDigest = r + ":")))) : (e.MMIsChatRoom = !1, i = e.Content), e.MMIsSend || e.MMUnread != _aoUndefined || e.MsgType == confFactory.MSGTYPE_SYS || (e.MMUnread = !0), e.LocalID || (e.ClientMsgId = e.LocalID = e.MsgId), i = emojiFactory.emoticonFormat(i), e.MMActualContent = i, e.MMActualSender = o || e.FromUserName, n._calcMsgDisplayTime(a[a.length - 1], e)
            }, 
            ...
            _emojiMsgProcess: function (e) {
              var t = this;
              if (e.HasProductId) e.MMIsSend ? e.MMActualContent = "" + _("80f56fb") : e.MMActualContent = _("2242ac7") + "", e._noSupportMsg = !0, t._textMsgProcess(e); else {
            ...
            _appAudioMsgProcess: function (e) {
              var t = this, a = _("0e23719") + e.FileName;
              t._appUrlMsgProcess(e, a)
            }, 
            _appVideoMsgProcess: function (e) {
              var t = this, a = _("4078104") + e.FileName;
              t._appUrlMsgProcess(e, a)
            }, 
            _appOpenMsgProcess: function (e) {
              var t = this, a = _("4f20785");
            ...
            _appRealtimeShareLocationMsgProcess: function (e) {
              var t = "";
              if (e.FromUserName == accountFactory.getUserName()) t = "[" + _("8e94ca5") + "]"; else {
            ...
            _recalledMsgProcess: function (e) {
              var t, a, n = this, i = utilFactory.htmlDecode(e.MMActualContent), o = "", r = _("ded861c"),
                  c = n.getChatMessage(e.MMPeerUserName);
              if (i = utilFactory.encodeEmoji(i), o = utilFactory.xml2json(i).revokemsg, 0 == o.msgid) {
                for (var s = c.length - 1; s >= 0; --s) if (c[s].FromUserName == accountFactory.getUserName()) {
                  t = s;
                  break
                }
              ...
              if (t > -1) {
                var l = c[t];
                if (l.MMIsSend) a = _("df1fd91"); else {
            ...
            _recommendMsgProcess: function (e) {
              e.Contact = e.RecommendInfo, e.MsgType == confFactory.MSGTYPE_VERIFYMSG ? e.Content = e.Contact.NickName || e.Contact.UserName + _("ebeaf99") : e.Content = e.Contact.NickName || e.Contact.UserName + "text_posible_friend_msg_digest"
            },
            ...
            _systemMsgProcess: function (e) {
              ...
              if (t) for (var a, n, i = 0, o = t.length; i < o; ++i) a = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[i]), a && a[1] && (n = a[1], e.MMActualContent = e.MMActualContent.replace(/&lt;a href=(?:'|")weixin:\/\/.*?&lt;\/a&gt;/, ""));
            ...
            _notify: function (e) {
              function t() {
                ...
                var d = notificationFactory.createNotification(utilFactory.clearHtmlStr(a), {body: r, icon: n});
                d && (d.onclick = function () {
                  try {
                    window.focus(), $rootScope.$broadcast("root:notification:click", e.FromUserName)
                  } catch (e) {
                    reportService.report(reportService.ReportType.logicError, {text: "notification click"})
                  }
                })
              }
            ...
            notifyMobile: function (e, t) {
              ...
              if (t && !(t.MsgType < 0)) if (!e || e.MsgType < 0) {
                ...
                var a = new Date(1e3 * t.CreateTime);
                t.MMDigestTime = a.getHours() + ":" + utilFactory.formatNum(a.getMinutes(), 2), Math.abs(e.MMDisplayTime - t.CreateTime) >= 180 ? (t.MMDisplayTime = t.CreateTime, t.MMTime = t.MMDigestTime) : (t.MMDisplayTime = e.MMDisplayTime, t.MMTime = "")
              }
    ...
    angular.module("Services").factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c, s, l, d) {
      var f, u = {}, m = {
        setCurrentContact   : function (e) {
          ...
          var t = n.defer(), i = angular.extend({MemberCount: e.length, MemberList: e, Topic: ""}, o.getBaseRequest());
          return a({method: "POST", url: c.API_webwxcreatechatroom + "?r=" + s.now(), data: i}).success(function (e) {
          ...
          n.MemberList.length + t.split(",").length >= 40 ? this._update("invitemember", e, {inviteMembers: t}, a) : this._update("addmember", e, {addMembers: t}, a)
        }, delMember        : function (e, t) {
          this._update("delmember", e, {delMember: t});
          i.getContact(e)
        }, quit             : function (e) {
          this._update("quitchatroom", e)
        }, modTopic         : function (e, t) {
          this._update("modtopic", e, {topic: t})
          ...
          var s                     = angular.extend({
            ...
            NewTopic        : n.topic,
            ChatRoomName    : t
          }, o.getBaseRequest()), d = c.API_webwxupdatechatroom + "?fun=" + e;
          a({method: "POST", url: d, data: s}).success(function (a) {
            ...
            l.report(l.ReportType.netError, {text: "update classroom net error", url: d, params: s})
          })
        }
      };
      return m
  ...
  !function () {
    ...
    angular.module("Services").factory("accountFactory", ["$q", "confFactory", "utilFactory", function (e, t, a) {
      var n, i, o, r = {}, c = null, s = null, l = {type: "", ver: ""},
          ...
          u = {
            openNotify: function () {
              ...
              var t = parseInt(e, 10).toString(16), a = t.substr(0, 1), t = t.substr(1, 3).replace("0", ".");
              l.type = a, l.ver = t
            }
          };
  ...
  !function () {
    ...
    angular.module("Services").factory("confFactory", ["$q", function (e) {
      var t = location.host, a = "login.weixin.qq.com", n = "file.wx.qq.com", i = "webpush.weixin.qq.com";
  ...
  !function () {
    ...
    angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c, s, l, d) {
      ...
      var u, m = window._contacts = {}, g = window._strangerContacts = {}, p = [], h = [], M = [], v = [],
          y = window._chatRoomMemberDisplayNames = {},
          b = [], C = [], w = [], S = {}, T = {}, N = 0, E = ["fmessage"], G = {
            isSelf: function () {
              ...
              if (c.isRoomContact(t.UserName)) if (a = t.RemarkName || t.NickName, !a && t.MemberList) for (var n = 0, i = t.MemberList.length; n < i && n < 10; ++n) {
                a.length > 0 && (a += ", ");
                var o = t.MemberList[n], r = I.getContact(o.UserName);
                a += r && r.RemarkName || r && r.NickName || o.NickName
              } else a || (a = t.UserName); else a = t.RemarkName || e && e != t.UserName && t.getMemberDisplayName(e) || t.NickName;
              return a
              ...
              if (this.isRoomContact()) {
                ...
                for (var t = 0, a = this.MemberList.length; t < a; t++) {
                  var n = this.MemberList[t].UserName, i = I.getContact(n);
              ...
              if (!e) return !0;
              e = e.toUpperCase();
              var a = this.RemarkName || "", n = this.RemarkPYQuanPin || "", i = this.NickName || "",
                  o = this.PYQuanPin || "", r = this.Alias || "", c = this.KeyWord || "", s = 0, l = 0;
              return s = a.toUpperCase().indexOf(e), l = n.toUpperCase().indexOf(e), s >= 0 || l >= 0 || (s = i.toUpperCase().indexOf(e), l = o.toUpperCase().indexOf(e), s >= 0 || l >= 0 || (r.toUpperCase().indexOf(e) >= 0 || c.toUpperCase().indexOf(e) >= 0))
            }, update: function (e) {
              e && angular.extend(this, e)
            }
          }, I = {
            contactChangeFlag: "", setCurrentContact: function (e) {
              u = e
            }, getCurrentContact: function () {
              return u
            }, isSelf: function (e) {
              ...
              return t({
                ...
                params: {skey: o.getSkey(), pass_ticket: o.getPassticket(), seq: e, r: c.now()}
              }).success(function (e) {
                n.resolve(e)
              }).error(function (e) {
              ...
              var t = {weixin: _("6c2fc35"), filehelper: _("eb7ec65"), newsapp: _("0469c27"), fmessage: _("a82c4c4")};
              return t[e.UserName] && (e.NickName = t[e.UserName]), "fmessage" == e.UserName && (e.ContactFlag = 0), e
            }, addContact: function (e) {
              e && (e.isContact || (e = f(e), e.MMOrderSymbol = this.getContactOrderSymbol(e)), e.EncryChatRoomId && e.UserName && (e.MMFromBatchget = !0), e.RemarkName = e.RemarkName && r.transformSpanToImg(e.RemarkName), e.NickName = e.NickName && r.transformSpanToImg(e.NickName), e.isShieldUser() || !e.isContact() && !e.isRoomContact() ? this.addStrangerContact(e) : this.addFriendContact(e))
              ...
              if (e) {
                ...
                a.contactChangeFlag = +new Date, s.load({url: e.HeadImgUrl, type: "image"})
              }
              ...
              s.load({url: e.HeadImgUrl, type: "image"})
              ...
              function r(e) {
                f.resolve(e.ContactList), N = 0, angular.forEach(e.ContactList, function (e) {
                  var t = u.inContactsToGetList({UserName: e.UserName});
                  t > -1 && b.splice(t, 1), c.isRoomContact(e.UserName) && e.MemberList && e.MemberList.length ? angular.forEach(e.MemberList, function (t) {
                    ...
                    var n = u.inContactsToGetList({UserName: t.UserName});
                    n > -1 && b.splice(n, 1)
                  }) : u.addChatroomMemberDisplayName(e, e.UserName)
                }), u.addContacts(e.ContactList, !0), C = [], !C.length && b.length > 0 && u.batchGetContact().then(r, s)
              }
              ...
              if (c.isRoomContact(e)) {
                ...
                t && t.MMFromBatchGet || this.addBatchgetContact({UserName: e, ChatRoomId: ""})
              }
            }, addBatchgetChatroomMembersContact    : function (e) {
              var t = this, a = t.getContact(e);
              ...
              return w.length ? (r = w.length < 6 || N > 2 ? 1 : w.length < 40 ? 5 : 10, C = w.splice(0, r)) : C = b.splice(0, 50), t({
                ...
                l.report(l.ReportType.netError, {text: "batchGetContact", url: i.API_webwxbatchgetcontact}), n.reject(e)
              }), n.promise
              ...
              return this.prevSearchCanceler && this.prevSearchCanceler.resolve(), this.prevSearchCanceler = a.defer(), T[e] ? r.resolve(n(T[e])) : t({
                ...
                data: angular.extend(o.getBaseRequest(), {KeyWord: e})
              }).success(function (t) {
              ...
              for (var n, i, o, r = [], c = this, s = t.all || {}, l = 0; l < e.length; l++) switch (n = e[l], o = t[n] || {}, o = $.extend({}, o, s), n) {
                ...
                case"friend":
                  if (i = c.getAllFriendContact(o), i.length > 0) {
                    o.showFriendHeader && r.push({text: _("59d29a3"), type: "header"});
                    var d = "";
                    o.showFriendHeader || o.noHeader || angular.forEach(i, function (e, t) {
                      if (e.MMOrderSymbol) {
                        var a = e.MMOrderSymbol.charAt(0);
                        d != a && (d = a, i.splice(t, 0, {text: a, type: "header"}))
                      }
                    }), [].push.apply(r, i)
                  }
                  break;
              ...
              return a && (r = angular.copy(r)), {result: r}
              ...
              var n = a.defer(), r = {
                ...
                VerifyUserList: [{Value: e.UserName, VerifyUserTicket: e.Ticket || ""}],
  ...
  !function () {
    ...
    angular.module("Services").factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function (e, t, a, n, i, o, r, c) {
      var s = {
        getUUID            : function () {
          var e = t.defer();
          return window.QRLogin = {}, $.ajax({url: i.API_jsLogin, dataType: "script"}).done(function () {
        ...
        checkLogin      : function (e, a) {
          ...
          return window.code = 0, window.checkLoginPromise = $.ajax({
            ...
            var e = {code: window.code, redirect_uri: window.redirect_uri, userAvatar: window.userAvatar};
            n.resolve(e)
          }).fail(function () {
            n.reject()
          }), n.promise
        ...
        associationLogin: function (e) {
          var a = t.defer(), n = i.API_webwxpushloginurl + "?uin=" + encodeURIComponent(e);
          return $.ajax({url: n, dataType: "json"}).done(function (e) {
        ...
        newLoginPage    : function (e) {
          ...
          return r({
            ...
            MMRetry: {count: 3, timeout: 1e4, serial: !0}
          }).success(function (e) {
            c.report(c.ReportType.timing, {timing: {loginEnd: Date.now()}}), a.resolve(e)
          }).error(function (e) {
            a.reject("error:" + e)
          }), a.promise
        }, 
        loginout        : function (e) {
          ...
          o.form(t, {sid: n.getSid(), uin: n.getUin()})
        }, 
    ...
    angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory", function (e, a, n) {
      function i(e, t, a, n) {
        ...
        (i = d[e]) ? (i.intervalSum += a, n && n <= i.intervalSum && (setTimeout(t, 0), d[e].intervalSum = 0), clearTimeout(i.timer), i.timer = setTimeout(function () {
          ...
          intervalSum: 0, timer: setTimeout(function () {
            delete d[e]
          }, a)
        })
      }
      ...
      var o, r = {},
          ...
          l = ["newsapp", "wxid_novlwrv3lqwv11", "gh_22b87fa7cb3c", "notification_messages"], d = {};
      ...
      var f = {
        ...
        clearCookie         : function () {
          for (var e = document.cookie.split(";"), t = 0; t < e.length; t++) {
            var a           = e[t], n = a.indexOf("="), i = n > -1 ? a.substr(0, n) : a;
        ...
        hrefEncode          : function (e) {
          var t = this, a = e.match(/&lt;a href=(?:'|").*?(?:'|").*?&gt;.*?&lt;\/a&gt;/g);
          if (a) {
            for (var n, i, o = 0, r = a.length; o < r; ++o) n = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(a[o]), n && n[1] && (i = n[1], t.isUrl(i) && (e = e.replace(n[0], this.htmlDecode(n[0])).replace(n[1], f.genCheckURL(n[1]))));
            return e
          }
        ...
        formatNum           : function (e, t) {
          var a = (isNaN(e) ? 0 : e).toString(), n = t - a.length;
        ...
        initMsgNoticePlayer : function (e) {
          t.e(2, function (require) {
            ...
            a.jPlayer({
              ready     : function () {
              }, swfPath: window.MMSource.jplayerSwfPath, solution: "html, flash", supplied: "mp3", wmode: "window"
            }), a.jPlayer("stop"), a.jPlayer("setMedia", {mp3: e}), a.jPlayer("play")
          })
        },
        ...
        queryParser         : function () {
          for (var e = {}, t = location.search.substring(1), a = t.split("&"), n = 0, i = a.length; n < i; n++) {
            var o = a[n].split("="), r = decodeURIComponent(o[0]);
        ...
        getSize             : function (e) {
          if (e = +e) {
            var t = 10, a = 10, n = 20, i = 1 << a, o = 1 << n;
            if (e >> n > 0) {
        ...
        reportSendState     : function (e, t) {
          var a = 63637, n = this.browser.msie, i = {
            sendFileWrong           : {ie: 63, notIe: 64},
            sendImageWrong          : {ie: 65, notIe: 66},
            uiCheckFail             : {ie: 84, notIe: 84},
            MD5TimeBigFilePerMb     : {ie: 69, notIe: 70},
            MD5TimeSmallFile        : {ie: 71, notIe: 72},
            MD5TimeBigFilePerMbCount: {ie: 73, notIe: 74},
            MD5TimeSmallFileCount   : {ie: 75, notIe: 76},
            sendcheckElementError   : {ie: 77, notIe: 77},
            sendcheckAttrError      : {ie: 78, notIe: 78},
            chatCurrentNameNotFound : {ie: 79, notIe: 79},
            navcurrentNameNotFound  : {ie: 80, notIe: 80},
            toUserNameNotFound      : {ie: 81, notIe: 81},
            toUserNameConflictNav   : {ie: 82, notIe: 82},
            toUserNameConflictChat  : {ie: 83, notIe: 83},
            sendFile                : {ie: 86, notIe: 86}
          }, o  = i[e];
  ...
  !function () {
    ...
    angular.module("Services").factory("screenShotFactory", ["confFactory", "reportService", function (e, t) {
      ...
      function r(a, i) {
        var r = n();
        r.StopUpload(), r.ClearHeaders(), r.ClearFormItems(), r && (r.URL = (MMDEV ? "http://wx.qq.com" : "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", r.AddHeader("Cookie", document.cookie), r.AddFormItem("msgimgrequest", 0, 0, a), r.AddFormItem("filename", 1, 4, o()), r.OnEvent = function (e, a) {
          switch (a) {
            case 2:
              break;
            case 3:
              ...
              break;
            case 1:
              t.report(t.ReportType.uploaderError, {text: "screensnap upload error", url: r.URL}), i({}), r = null
          }
        }, r.StartUpload())
      }

      var c = "screencapture", s = "uploader", l = null, d = null;
      return {
        isSupport          : function () {
          ...
          var t = a();
          t && (t.OnCaptureFinished = e.ok), t.OnCaptureCanceled = function () {
          }, t.DoCapture()
  ...
  !function () {
    ...
    angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
      ...
      function i() {
        var e;
        if (g) return window.Notification && window.Notification.permissionLevel ? e = window.Notification.permissionLevel() : window.webkitNotifications && window.webkitNotifications.checkPermission ? e = f[window.webkitNotifications.checkPermission()] : window.Notification && window.Notification.permission ? e = window.Notification.permission : navigator.mozNotification ? e = l : window.external && void 0 !== window.external.msIsSiteMode() && (e = window.external.msIsSiteMode() ? l : s), e
      }
      ...
      var s = "default", l = "granted", d = "denied", f = [l, s, d],
          u = {pageVisibility: !1, autoClose: 5e3, total: 3}, m = "", g = function () {
            var t = !1;
            try {
            ...
            return t
          }(), p = Math.floor(10 * Math.random() + 1), h = [], M = u, v = {
    ...
    angular.module("Services").factory("resourceService", ["$timeout", "$http", "$q", "$window", function (e, t, a, n) {
      function i(t, a, n) {
        ...
        for (var i, r = a.priority ? c : s, d = l.push({
          callback  : n || function () {
          }, taskNum: t.length, combo: a.combo, result: {}
  ...
  !function () {
    ...
    angular.module("Services").factory("stateManageService", ["$http", "$q", function (e, t) {
      function a(e) {
        if ("object" == typeof e) for (var t in e) i[t] !== e[t] && n(t, e[t]), i[t] = e[t]
      }
      ...
      var i = {
        ...
        "navChat:active"   : {"navContact:active": !1, "navRead:active": !1},
        "navRead:active"   : {"navChat:active": !1, "navContact:active": !1},
        "navContact:active": {"navChat:active": !1, "navRead:active": !1}
      }, c  = {
        navKeydown  : function () {
      ...
      return {
        feedback: function (n) {
          e({
            ...
            data  : angular.extend(t.getBaseRequest(), {MachineType: "webwx", Content: n, ReportType: 0})
          })
        }
      }
    }])
  ...
  !function () {
    ...
    angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, a, n) {
      ...
      function o(e) {
        e.needSend ? (p({
          Type: 1,
          Text: JSON.stringify({type: N.timing, data: i()})
        }, !0), I = !0, f()) : e.fullTiming ? p({
          Type: 1,
          Text: JSON.stringify({type: N.timing, data: e.fullTiming})
        }, !0) : $.extend(G, e.timing)
      }

      function r(e) {
        return {message: e.message, stack: e.stack && e.stack.replace(/\n/g, "\\n"), other: e.other}
      }
      ...
      function s(e, t) {
        ...
        var i = JSON.stringify({type: e, data: n});
        return i
      }
      ...
      function d(e, t, a) {
        if (void 0 != typeof e) {
          ...
          e.indexOf("send-error") > 0 ? (i = !0, n = {
            Type: 16,
            Text: s(e, t)
          }) : (e.indexOf("-error") > 0 ? (i = !0, n = {Type: 2, Text: s(e, t)}) : n = {
            Type: 1,
            Text: s(e, t)
          }, p(n, i))
        }
      ...
      function u() {
        $(window).unload(function () {
          w.unload = g(t), C.push({type: N.runtime, data: w}), !I && C.push({
            type: N.timing,
            data: {fullTiming: i()}
      ...
      function g(e, t) {
        t || (t = {listenerCount: 0, watchersCount: 0, scopesCount: 0});
      ...
      function M(t) {
        e({
          ...
          data  : {
            BaseRequest: {Uin: n.getUin(), Sid: n.getSid(), DeviceID: n.getDeviceID()},
            Count      : t.length,
            List       : t
          }
        }).success(function (e) {
  ...
  !function (t, a) {
    ...
    return function (e) {
      ...
      function i(e, t, a) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, i = e + "-" + t, o = l.get(i);
        ...
        void 0 === r && (r = (0, s.default)(function () {
          ...
          if (void 0 !== a) {
            ...
            (new Image).src = n, l.clear(i), d.clear(i)
          }
        }, n, {leading: !1}), d.set(i, r)), r()
      }

      Object.defineProperty(t, "__esModule", {value: !0});
      var o = a(1), r = n(o), c = a(2), s = n(c), l = (0, r.default)(), d = (0, r.default)();
      ...
      function n(e, t) {
        var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, n = void 0, i = void 0, o = void 0,
            r = 0, c = function () {
              r = a.leading === !1 ? 0 : (new Date).getTime(), n = null, e.apply(i, o), n || (i = o = null)
            }, s = function () {
  ...
  !function () {
    ...
    angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, a) {
      function n(n) {
        function i(t, n) {
          e[t].apply(e, n).success(r).error(c), a(function () {
            l.complete || s()
          }, m)
        }
        ...
        var l = n.data, d = n.config, f = d.MMRetry, u = "undefined" == typeof f.count ? 3 : f.count,
            m = f.timeout || 15e3, g = f.serial, p = [], h = [], M = 0, v = t.defer(), y = 0;
      ...
      for (var i, o = function (e) {
        var t = e.method ? e.method.toLowerCase() : "get", a = e.url, n = e.data, i = [a];
        ...
        return function (a) {
          ...
          var s;
          return s = c ? n({args: r, method: t, config: o, data: {complete: !1}}) : e[t].apply(e, r)
        }
      }(i);
      return o
    }])
  ...
  !function (e) {
    ...
    angular.module("Services").factory("titleRemind", ["$window", function (e) {
      function t(e, t) {
        ...
        var i, o;
        "undefined" != typeof n.hidden ? (i = "hidden", o = "visibilitychange") : "undefined" != typeof n.mozHidden ? (i = "mozHidden", o = "mozvisibilitychange") : "undefined" != typeof n.msHidden ? (i = "msHidden", o = "msvisibilitychange") : "undefined" != typeof n.webkitHidden && (i = "webkitHidden", o = "webkitvisibilitychange"), "undefined" == typeof n.addEventListener || "undefined" == typeof i ? ($(window).focus(function () {
          t()
      ...
      var a = !0, n = e.document, i = {
        defaultTitle           : _("2f521c5"), unreadMsgNum: 0, start: function () {
          var e = this;
  ...
  !function (e) {
    ...
    angular.module("Services").factory("subscribeMsgService", ["$rootScope", "contactFactory", "accountFactory", "confFactory", "utilFactory", function (e, t, a, n, i) {
      var o = [], r = {
        current            : null, changeFlag: 0, init: function (e) {
          ...
          for (var t = 0, n = e.length; t < n; t++) {
            var r        = e[t];
            r.HeadImgUrl = r.HeadImgUrl = i.getContactHeadImgUrl({UserName: r.UserName, Skey: a.getSkey()});
  ...
  !function () {
    ...
    angular.module("Directives").directive("messageDirective", ["$timeout", "confFactory", function (e, t) {
      return {
        restrict: "A", templateUrl: "message.html", link: function (e, t, a) {
        }
      }
    }])
  }()
  ...
  angular.module("Directives").directive("ngInput", ["$parse", function (e) {
    return function (t, a, n) {
      ...
      a.bind("input propertychange", function (e) {
        t.$$phase ? i(t, {$event: e}) : t.$apply(function () {
          i(t, {$event: e})
        })
      })
    }
  ...
  angular.module("Directives").directive("mmpopDirective", ["$timeout", "$document", "mmpop", "$animate", function (e, t, a, n) {
    return {
      restrict: "EA", scope: {}, link: function (e, t, a) {
      }
    }
    ...
    this.$get        = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", "$animate", function (o, r, c, s, l, d, f, u, m, g) {
      var p = o.find("body"), h = {
        onDocumentKeydown : function (e) {
          ...
          }), i[a] && (i[a].resolve({id: a, value: t, $pop: e, remainingPops: n}), delete i[a]))
        }, closePop       : function (e, t) {
          h.performClosePop(e, t)
        }
      }, M  = {
        open         : function (l) {
          var u = this, v = angular.copy(t);
          ...
          if (S = v.container ? v.container : p, c(w)(C), g.enter(w, S), v.autoFoucs && w.focus(), v.controller && (angular.isString(v.controller) || angular.isArray(v.controller) || angular.isFunction(v.controller))) {
            m(v.controller, {$scope: C, $element: w})
          }
  ...
  angular.module("Directives").directive("contenteditableDirective", ["$timeout", "utilFactory", "confFactory", function (e, t, a) {
    return {
      restrict: "A", require: "?ngModel", link: function (e, n, i, o) {
        function r(e) {
        ...
        if (o) {
          ...
          n.bind("paste", function () {
            var e = this, i = e.innerHTML;
            s && clearTimeout(s), s = setTimeout(function () {
              for (var c = e.innerHTML, l = -1, d = -1, f = 0, u = c.length; f < u && (l == -1 && i.substr(f, 1) != c.substr(f, 1) && (l = f), d == -1 && i.substr(i.length - f - 1, 1) != c.substr(c.length - f - 1, 1) && (d = f), !(l != -1 && d != -1 || u - 1 - d <= l)); ++f) ;
              if (l != -1 && d != -1) {
                if (d = u - 1 - d, d <= l) {
                  f = l;
                ...
                var g = c.substring(l, d + 1), p = c.substr(0, l), h = c.substr(l + g.length), M = p.lastIndexOf("<"),
                    v = p.lastIndexOf(">");
  ...
  !function () {
    ...
    angular.module("Directives").directive("miniUserProfileDirective", ["$timeout", "confFactory", function (e, t) {
      return {
        ...
        scope      : {user: "=", showOrderc: "=", hasCheckbox: "=", selectedUsers: "=", clickUserCallback: "="},
        link       : function (e, t, a) {
        }
      }
    }]).directive("userProfileDirective", ["$timeout", "confFactory", function (e, t) {
      return {
        restrict: "A", scope: {user: "="}, templateUrl: "userProfile.html", link: function (e, t, a) {
        }
      }
    }])
  }()
  ...
  !function () {
    ...
    angular.module("Directives").directive("contactItemDirective", ["$timeout", "confFactory", function (e, t) {
      return {
        ...
        replace    : !0,
        scope      : {className: "@", user: "=", showOrderSymbol: "=", orderSymbol: "=", clickUserCallback: "="},
        link       : function (e, t, a) {
        }
      }
      ...
      return {
        ...
        scope      : {user: "=", showOrderSymbol: "=", orderSymbol: "=", isCheck: "=", clickUserCallback: "="},
        link       : function (e, t, a) {
        }
      }
    }])
  ...
  !function (e, t) {
    ...
    e.module("Directives").directive("scrollGlue", ["$parse", "$timeout", function (e, a) {
      ...
      return {
        priority: 1, restrict: "A", link: function (e, t, n) {
          function i() {
  ...
  !function (e) {
    ...
    angular.module("Directives").directive("jplayerDirective", ["$timeout", "utilFactory", function (a, n) {
      return {
        restrict: "A", link: function (i, o, r) {
          function c() {
            t.e(2, function (require) {
              t(281);
              jQuery(o).jPlayer({
                ready          : function () {
                  jQuery(this).jPlayer("setMedia", {
                    ...
                    poster: r.poster
                  }), r.muted !== e && jQuery(this).jPlayer("mute"), r.loop !== e && u && (jQuery(this).jPlayer("play"), s())
                },
                click          : function () {
          ...
          function s() {
            l(), d = a(function () {
              jQuery(o).jPlayer("stop"), jQuery(o).jPlayer("play"), s()
            }, f)
          }
  ...
  angular.module("Directives").directive("previewDirective", ["$document", "confFactory", "utilFactory", function (e, t, a) {
    return {
      restrict: "EA", templateUrl: "preview.html", scope: {imageList: "=", current: "="}, link: function (n, i, o) {
        function r(e) {
          switch (e.keyCode) {
            case t.KEYCODE_ARROW_UP:
        ...
        function s(e) {
          var t, a;
          if (e.scale) t = e.scale, a = {x: .5, y: .5}; else {
            var n = e.delta;
            a = e.posRatio || {x: .5, y: .5}, t = y.scale, t = n > 0 ? t + S : t - S
          }
          t     = t > w ? w : t < 1 / w ? 1 / w : t;
          var i = {width: Math.round(v.width * t), height: Math.round(v.height * t), scale: t};
        ...
        function d(e) {
          l({top: e.clientY - b.y + C.top, left: e.clientX - b.x + C.left}), e.preventDefault()
        }

        function f() {
          m.on("mousedown", function (e) {
            return G ? void n.actions.close() : (b = {x: e.clientX, y: e.clientY}, C = {
              top : y.top,
              left: y.left
            ...
            "mousewheel" != a.type && "DOMMouseScroll" != a.type || (t = a.wheelDelta ? a.wheelDelta / 120 : -(a.detail || 0) / 3), void 0 !== t && (s(G ? {delta: t} : {
              delta   : t,
              posRatio: {
                x: a.offsetX / y.width,
        ...
        function u() {
          ...
          var t = new Image;
          t.onload = function () {
            t.onload = null, v = {width: t.width, height: t.height}, y = {
              width : v.width,
              height: v.height,
              top   : (M - v.height) / 2,
              left  : (h - v.width) / 2,
            ...
            var e = N / t.height, a = T / t.width;
            e < 1 && a < 1 ? s({scale: e < a ? e : a}) : e < 1 ? s({scale: e}) : a < 1 ? s({scale: a}) : m.css(y), angular.extend(E, y), p[0].src = t.src, n.isLoaded = !0, n.containerStyle = null, n.$digest()
          }, t.onerror = function () {
            t.onerror = null, alert(_("845ec73"))
          }, t.src = n.imageList[n.current].url
        }

        var m = i.find("#img_dom"), g = i.find("#img_opr_container"), p = m.find("#img_preview"),
        ...
        n.isLoaded = !1, n.rotateDeg = 0, n.isIE = !!(a.browser.msie && a.version < 10), n.actions = {
          ...
          rotate: function () {
            n.rotateDeg = (n.rotateDeg + 90) % 360, s({scale: E.scale}), l({
              top : (M - y.height) / 2,
              left: (h - y.width) / 2
        ...
        var v, y, b, C, w = 5, S = .1, T = .8 * h, N = .8 * M, E = {}, G = void 0 !== document.mozHidden,
  ...
  angular.module("Directives").directive("mmlazyDirective", function (e) {
    return {
      restrict: "A", link: function (e, t) {
        var a = "scrollLazyload", n = function () {
          $("img.lazy").lazyload({container: t, event: a})
        };
        n()
      }
    }
    ...
    return {
      restrict: "A", link: function (t, a) {
        var n, i = "scrollLazyload", o = function () {
          $("img.lazy").lazyload({container: a, event: i})
    ...
    return {
      link       : function (e, t) {
        setTimeout(function () {
          t.scrollbar({
            test       : "test", type: "simpble", onScroll: function (t, a) {
              e.$broadcast("onScroll", {y: t, x: a})
            }, onUpdate: function () {
  ...
  !function (o, r) {
    ...
    "use strict";
    var a = e.module("ngDialog", []), n = e.element, i = e.isDefined,
        ...
        c = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", s = !1;
    a.provider("ngDialog", function () {
        ...
        var b = {
          onDocumentKeydown    : function (e) {
            ...
            if ("undefined" != typeof M.Hammer) {
              ...
              s.off("tap", a), s.destroy && s.destroy(), delete t.scope().hammerTime
            } else t.unbind("click");
            1 === o && y.unbind("keydown"), t.hasClass("ngdialog-closing") || (o -= 1), p.$broadcast("ngDialog.closing", t), r ? t.unbind(c).bind(c, function () {
              t.scope().$destroy(), t.remove(), 0 === o && (y.removeClass("ngdialog-open"), b.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)
            }).addClass("ngdialog-closing") : (t.scope().$destroy(), t.remove(), 0 === o && (y.removeClass("ngdialog-open"), b.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)), l[i] && (l[i].resolve({
              id              : i,
              value           : n,
              $dialog         : t,
              remainingDialogs: o
          ...
          open          : function (r) {
            ...
            function s(t) {
              return t ? e.isString(t) && w.plain ? t : "boolean" != typeof w.cache || w.cache ? f.get(t) || c(t, {cache: !0}) : c(t, {cache: !1}) : "Empty template"
            }

            var d = this, w = e.copy(t);
            ...
            return m.when(s(w.template || w.templateUrl)).then(function (t) {
              ...
              if (w.controller && (e.isString(w.controller) || e.isArray(w.controller) || e.isFunction(w.controller))) {
                var c = v(w.controller, {$scope: E, $element: T});
              ...
              if (w.className && T.addClass(w.className), N = w.appendTo && e.isString(w.appendTo) ? e.element(document.querySelector(w.appendTo)) : y, w.preCloseCallback) {
                var s;
                e.isFunction(w.preCloseCallback) ? s = w.preCloseCallback : e.isString(w.preCloseCallback) && E && (e.isFunction(E[w.preCloseCallback]) ? s = E[w.preCloseCallback] : E.$parent && e.isFunction(E.$parent[w.preCloseCallback]) ? s = E.$parent[w.preCloseCallback] : p && e.isFunction(p[w.preCloseCallback]) && (s = p[w.preCloseCallback])), s && T.data("$ngDialogPreCloseCallback", s)
              }
              ...
              id: "ngdialog" + i, closePromise: S.promise, close: function (e) {
                b.closeDialog(T, e)
              }
            }
          }, openConfirm: function (t) {
            var a = m.defer(), i = {closeByEscape: !1, closeByDocument: !1};
      ...
      return {
        restrict: "A", scope: {ngDialogScope: "="}, link: function (a, n, i) {
  ...
  angular.module("Directives").directive("mmRepeat", ["$document", "$compile", "$rootScope", function (e, t, a) {
    function n(e, t, a, n, i) {
      ...
      if (a > n) {
        for (var s = t; s > -1; s--) if (o = e[s], r = c, c += o._h || (o._h = i(o)), a - c < n) return {
          index: s,
          total: r
        };
        return {index: 0, total: 0}
      }
      for (var s = t; s < e.length; s++) if (o = e[s], r = c, c += o._h || (o._h = i(o)), a + c > n) return {
        index: s,
        total: r
      };
      return {index: e.length - 1, total: c}
    }
    ...
    function o(e, t, a, o) {
      ...
      return f > 0 ? (d = n(e, 0, 0, f, o), r = d.index, f = d.total) : (r = 0, f = 0), c = n(e, r, f, u, o).index, c = c >= e.length ? e.length - 1 : c, s = i(e, 0, r, o), l = i(e, c + 1, e.length, o), {
        topHeight   : s,
        bottomHeight: l,
        startIndex  : r,
        endIndex    : c
    ...
    function c(e) {
      if (!(e.length <= 0)) for (var t, a = 0, n = 0; n < e.length; n++) t = e[n], t._offsetTop = a, a += t._h
    }

    function s(e, t, a) {
      if (!(e.length <= 0)) for (var n, i = 0; i < e.length; i++) n = e[i], n._h && !a || (n._h = t(n))
    }
    ...
    return {
      restrict: "EA", priority: 1e3, scope: !0, terminal: !0, link: function (e, a, n) {
        var i = [], o = {maxScroll: 0, scroll: 0, size: 0, visible: 687},
            f = n.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), u = f[2],
  ...
  angular.module("Directives").directive("mmRepeatKeyboard", ["$timeout", "utilFactory", "confFactory", function (e, t, a) {
    return {
      restrict: "A", priority: 1001, scope: !1, link: function (e, n, i) {
        function o(t) {
          e.$emit("mmrepeat:select", t)
        }

        function r(e, t, a) {
          var n = t._h, i = t._offsetTop, o = e.scrollTop;
        ...
        var s = i.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), l = s[2];
        e.$parent.$watch(l, function (e) {
          e && (d = e)
        });
        var d = e.$parent[l], f = i.mmRepeatKeyboardScrollSelector, u = $(f)[0];
        if (u) {
          var m, g = {};
    ...
    return {
      restrict: "A", link: function (e, t) {
        function a(e) {
          var t = n[e];
          if (t) {
            var a = t._h, o = t._offsetTop, r = i.scrollTop;
        ...
        var n = e.allContacts, i = t[0], o = n.length && n[0].type && "header" == n[0].type ? 1 : 0;
        n.length - 1;
        e.selectIndex = o, e.$on("root:searchList:keyArrowUp", function () {
          ...
          var t = n.length - 1, i = e.selectIndex;
  ...
  angular.module("Directives").directive("navChatDirective", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", function (e, t, a, n, i, o, r, c, s, l, d, f) {
    return {
      restrict: "EA", scope: !0, templateUrl: "navChat.html", link: function (t, a, n) {
        function r(e) {
        ...
        function u(e, t) {
          var a = t._h, n = t._offsetTop, i = e.scrollTop;
  ...
  angular.module("Directives").directive("navContactDirective", ["$rootScope", "$timeout", "$state", "contactFactory", "stateManageService", "confFactory", "utilFactory", function (e, t, a, n, i, o, r) {
    return {
      restrict: "EA", scope: !0, templateUrl: "navContact.html", link: function (c, s, l) {
        function d(t) {
          if (i.canDo("navKeydown")) {
            var a = c.allContacts, n = c.currentContact || a[0], s = n;
            r.wait(function () {
  ...
  angular.module("Directives").directive("navReadDirective", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "$state", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "subscribeMsgService", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m) {
    ...
    return {
      restrict: "EA", scope: !0, templateUrl: "navRead.html", link: function (e, t, a) {
        e.subscribeMsgs = [], e.articleList = [], e.subscribeMsgs.defaultValue = !0, e.$watch(function () {
          ...
          f.fitRun("navKeydown", function () {
            o.go("read", {readItem: a})
          }, 200, 1400), m.current = e.currentItem = a
        }), e.itemClick = function (t) {
          m.current = e.currentItem = t, e.mmRepeatKeyboard.setSelectItem(t), o.go("read", {readItem: t})
        }
      }
    }
  }])
  ...
  angular.module("Directives").directive("mmSrc", ["$document", "$timeout", "$rootScope", function (e, t, a) {
    return {
      priority: 99, link: function (e, a, n) {
        function i() {
        ...
        var s, l, d = "src", f = n.src, u = n.mmSrcTimeout ? parseInt(n.mmSrcTimeout) : 5e3,
            m = n.mmSrcRetryCount ? parseInt(n.mmSrcRetryCount) : 4, g = "undefined" != typeof n.mmSrcParallel,
            p = a[0], h = 0, M = !1, v = [], y = [], b = n.mmSrcLoad, C = n.mmSrcError;
  ...
  angular.module("Directives").directive("mmPaste", ["$timeout", "utilFactory", "stateManageService", function (e, t, a) {
    return {
      restrict: "EA", scope: {pasteLimit: "=", pasteResetTime: "="}, link: function (n, i, o) {
        var r, c = n.pasteLimit || 1, s = n.pasteResetTime || 200, l = 0;
        i.on("paste", function (n) {
          var i = n.originalEvent;
          return a.canDo("pasteFile") ? (t.browser.mozilla && i.clipboardData && 0 == i.clipboardData.types.length && (n.preventDefault(), n.stopImmediatePropagation()), void(l >= c ? (n.preventDefault(), n.stopImmediatePropagation()) : (r && e.cancel(r), r = e(function () {
            l = 0
  ...
  angular.module("Directives").directive("contactPicker", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "mmpop", function (e, t, a, n, i, o, r, c, s, l, d, f, u) {
    ...
    return {
      restrict   : "EA",
      scope      : {selectList: "=", pickConfig: "=", initList: "="},
      ...
      link       : function (t, a, n) {
        ...
        h.opt.all   = h.opt.all || {};
        var M       = t.initList || [];
        t.contactList = o(c.pickContacts(h.types, h.opt, !0).result, M), t.selectList = t.selectList || [], s(), t.search = function (a) {
          g && e.cancel(g), g = e(function () {
            if (t.keyword) {
              c.searchKey = t.keyword, p && p.close();
              var e = $.extend(m(t.selectList), h.opt.all.filterContacts), a = $.extend({}, h.opt, {
              ...
              t.contactList = c.pickContacts(h.types, a, !0).result, s(!0)
            } else t.contactList = o(c.pickContacts(h.types, h.opt, !0).result, M), s(!0)
          }, 200)
  ...
  angular.module("Directives").directive("mmActionTrack", ["actionTrack", "utilFactory", function (e, t) {
    var a = $(window), n = a.height(), i = a.width();
    return a.on("resize", function (o) {
      t.fitRun("resize", function () {
        var t = a.height(), o = a.width(), r = [], c = "height-" + (n > t ? "smaller" : "bigger"),
      ...
      priority: 99, scope: {types: "=trackType", opt: "=trackOpt"}, link: function (t, a, n) {
        var i = t.opt, o = t.types;
        for (var r in o) {
          var c = o[r];
          if ("keydown" == c) {
            var s = i.keys, l = {enter: 13, backspace: 8, blankspace: 32};
            a.on("keydown", function (t) {
              for (var a in s) l[s[a]] == t.keyCode && e.addRecord({type: "keydown", action: i.target + "-" + s[a]})
            })
          }
          if ("click" == c) {
            var d;
            a.on("click", function (t) {
              d && t.timeStamp - d <= 30 || (d = t.timeStamp, e.addRecord({type: "click", action: i.target}))
            })
          }
          "focus" == c && a.on("focus", function () {
            e.addRecord({type: "focus", action: i.target})
          })
        }
      }
    }
    ...
    var t = 100, a = [], n = {
      report      : function () {
        a.length > 0 && e.report(e.ReportType.actionRecord, {actions: a}, !0), a = []
  ...
  angular.module("Directives").directive("mmError", ["$parse", function (e) {
    return {
      restrict: "A", compile: function (t, a) {
        var n = e(a.mmError);
  ...
  !function (e, a, n) {
    ...
    a.module("ngClipboard", []).provider("ngClip", function () {
      ...
      return this.path = "//cdnjs.cloudflare.com/ajax/libs/zeroclipboard/2.1.6/ZeroClipboard.swf", {
        ...
        $get     : function () {
          return {path: e.path, config: e.config}
        }
      }
      ...
      var r = {swfPath: i.path, trustedDomains: ["*"], allowScriptAccess: "always", forceHandCursor: !0};
      e.ZeroClipboard ? o() : n.$on("root:pageInit:success", function () {
        o()
      })
    }]).directive("clipCopy", ["ngClip", function (e) {
      return {
        scope: {clipCopy: "&", clipClick: "&", clipClickFallback: "&"}, restrict: "A", link: function (e, n, i) {
          t.e(4, function (require) {
            var o = t(340);
            if (o.isFlashUnusable()) return void n.bind("click", function (t) {
              e.$apply(e.clipClickFallback({$event: t, copy: e.$eval(e.clipCopy)}))
            });
            var r = new o(n);
  ...
  !function () {
    "use strict";
    angular.module("Filters").filter("HTMLEnCode", function (e, t, a) {
      ...
      return function (e) {
        var e = 1e3 * e, a = new Date, n = a.getTime() / 1e3, i = a.getDay();
        a.setTime(e);
        var o, r = a.getHours(), c = a.getMinutes(), s = a.getDay(), l = a.getFullYear() % 100, d = a.getMonth() + 1,
            f = n - e > 604800, u = n - e < 86400 && s == i;
